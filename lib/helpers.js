...
function getCLIArguments() {
    return yargs
        ...
        .options({
            ...
            't': {
                alias: 'temp',
                default: userSettings['temp'] || Path.resolve(os.tmpdir(), packageSettings.name),
            ...
            'm': {
                alias: 'preset',
                default: userSettings['preset'] || 'medium',
            ...
            'tune': {
                default: userSettings['tune'] || 'none',
                describe: 'psnr, ssim, grain, zero-latency, fast-decode, animation',
                choices: ['psnr', 'ssim', 'grain', 'zero-latency', 'fast-decode', 'animation', 'none'],
                type: 'string',
                group: 'General:'
            },
            'ref': {
                default: userSettings['ref'] || 3,
                describe: 'Sets the number Reference Frames',
                type: 'number',
                group: 'General:'
            },
            'weightb': {
                default: userSettings['weightb'] || false,
                describe: 'Enable weighted prediction in B slices.',
                type: 'boolean',
                group: 'General:'
            },
            'bframes': {
                default: userSettings['bframes'] || 4,
                describe: 'Sets the number of B Frames',
                type: 'number',
                group: 'General:'
            },
            'as-preset': {
            ...
            //    choices: ['anime-high', 'anime-high-slow', 'anime-medium', 'testing-ssim', 'none'],
                type: 'string',
                group: 'Video:'
            },
            'stats-frequency': {
                default: userSettings['stats-frequency'] || 15,
                describe: 'How often the output is written in seconds',
                type: 'number',
                group: 'General:'
            },
            'diff-limit': {
                default: userSettings['diff-limit'] || 1,
                describe: 'The allowable difference in time between input and output lengths written in seconds',
                type: 'number',
                group: 'General:'
            },
            'n': {
            ...
            'delete': {
                ...
                describe: 'Delete source after encoding. [DANGER]',
                type: 'boolean',
                group: 'Advanced:'
            },
            'replace': {
